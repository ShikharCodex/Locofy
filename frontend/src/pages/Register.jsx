  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-slate-50 px-4 py-12 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -left-1/4 w-[800px] h-[800px] rounded-full bg-indigo-100/50 blur-3xl mix-blend-multiply"></div>
        <div className="absolute -bottom-1/2 -right-1/4 w-[600px] h-[600px] rounded-full bg-blue-100/50 blur-3xl mix-blend-multiply"></div>
      </div>
          ...
          <div className="px-8 pt-10 pb-8 sm:px-12 sm:pt-12">
            ...
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Join the community to help make a difference
              </p>
            </div>
